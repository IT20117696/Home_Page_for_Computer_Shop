...
<header class="header">
    ...
    <div class="cart-items-container">
        <div class="cart-item">
            ...
            <img src="/home/images/cart-item-1.png" alt=""/>
            <div class="content">
                <h3>cart item 01</h3>
        ...
        <div class="cart-item">
            <span class="fas fa-times"></span>
            <img src="/home/images/cart-item-2.png" alt=""/>
            <div class="content">
                <h3>cart item 02</h3>
                <div class="price">$15.99/-</div>
            </div>
        ...
        <div class="cart-item">
            <span class="fas fa-times"></span>
            <img src="/home/images/cart-item-3.png" alt=""/>
            <div class="content">
                <h3>cart item 03</h3>
                <div class="price">$15.99/-</div>
            </div>
        ...
        <div class="cart-item">
            <span class="fas fa-times"></span>
            <img src="/home/images/cart-item-4.png" alt=""/>
            <div class="content">
                <h3>cart item 04</h3>
                <div class="price">$15.99/-</div>
            </div>
...
<section class="about" id="about">
    ...
    <div class="row">
        <div class="image">
            <img src="/home/images/111.jpg" alt=""/>
        </div>
        <div class="content">
...
<section class="products" id="products">
   <h1 class="heading"> our <span>products</span> </h1>
    ...
    <div class="box">
        ...
        <div class="image">
            <img src="/home/images/22.jpg" alt=""/>
        </div>
        <div class="content">
    ...
    <div class="box">
        ...
        <div class="image">
            <img src="/home/images/12.jpg" alt=""/>
        </div>
        <div class="content">
...
<section class="review" id="review">
    <h1 class="heading"> customer's <span>review</span> </h1>
      <div class="box-container">
        <div class="box">
       <img src="/home/images/quote-img.png" alt="" class="quote"/>
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi nulla sit libero nemo fuga sequi nobis? Necessitatibus aut laborum, nisi quas eaque laudantium consequuntur iste ex aliquam minus vel? Nemo.</p>
    <img src="/home/images/pic-1.png" class="user" alt=""/>
    <h3>john deo</h3>
    <div class="stars">
        <i class="fas fa-star"></i>
        <i class="fas fa-star"></i>
...
<div class="box">
    <img src="/home/images/quote-img.png" alt="" class="quote"/>
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi nulla sit libero nemo fuga sequi nobis? Necessitatibus aut laborum, nisi quas eaque laudantium consequuntur iste ex aliquam minus vel? Nemo.</p>
    <img src="/home/images/pic-2.png" class="user" alt=""/>
    <h3>john deo</h3>
    <div class="stars">
        <i class="fas fa-star"></i>
        <i class="fas fa-star"></i>
...
<div class="box">
    <img src="/home/images/quote-img.png" alt="" class="quote"/>
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi nulla sit libero nemo fuga sequi nobis? Necessitatibus aut laborum, nisi quas eaque laudantium consequuntur iste ex aliquam minus vel? Nemo.</p>
    <img src="/home/images/pic-3.png" class="user" alt=""/>
    <h3>john deo</h3>
    <div class="stars">
        <i class="fas fa-star"></i>
        <i class="fas fa-star"></i>
